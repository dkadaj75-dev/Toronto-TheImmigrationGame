...
const lightEnvironment = doc.querySelector('input[data-path="light.environmentBonus"]');
assert(lightEnvironment && lightEnvironment.value === '', 'night Environment bonus is sparse and blank by default');
lightEnvironment.value = '0.08'; lightEnvironment.dispatchEvent(new window.Event('input', { bubbles: true }));
