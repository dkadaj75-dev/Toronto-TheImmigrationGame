...
const happiness={components:[{var:'needs.hunger',weight:2,min:0,max:100}],visaStatusRanks:{visitor:0,lmia:1}};
...
check(savedHappiness.components[0].weight===4,'happiness PUT contains edited formula');
